...
set CLASSPATH=%APP_HOME%\lib\Client-1.0-SNAPSHOT.jar;%APP_HOME%\lib\javafx-fxml-17.0.2-win.jar;%APP_HOME%\lib\javafx-fxml-17.0.2.jar;%APP_HOME%\lib\javafx-controls-17.0.2-win.jar;%APP_HOME%\lib\javafx-controls-17.0.2.jar;%APP_HOME%\lib\javafx-graphics-17.0.2-win.jar;%APP_HOME%\lib\javafx-graphics-17.0.2.jar;%APP_HOME%\lib\javafx-base-17.0.2-win.jar;%APP_HOME%\lib\javafx-base-17.0.2.jar;%APP_HOME%\lib\Networking.jar;%APP_HOME%\lib\Services.jar;%APP_HOME%\lib\Persistence.jar;%APP_HOME%\lib\log4j-core-2.23.1.jar;%APP_HOME%\lib\Model.jar;%APP_HOME%\lib\sqlite-jdbc-3.36.0.3.jar;%APP_HOME%\lib\log4j-api-2.23.1.jar


@rem Execute Client
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CLIENT_OPTS%  -classpath "%CLASSPATH%" org.example.StartRpcClient %*
